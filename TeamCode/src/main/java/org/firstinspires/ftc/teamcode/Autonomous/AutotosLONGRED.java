...
@Autonomous(name = "Autotos LONG RED  FIXED")
public class AutotosLONGRED extends OpMode {
    ...
    private void buildPaths() {
        ...
        Path2 = follower.pathBuilder().addPath(
                        new BezierCurve(
                                new Pose(88.000, 10.000),
                                new Pose(100.486, 49.687),
                                new Pose(48.692, 45.893),
                                new Pose(47.477, 27.953)
                        )
